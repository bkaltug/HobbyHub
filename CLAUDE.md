...
- The Flutter app lives in the `code/` subfolder.
...
- `docs/product_definition.md` — full MVP scope, screen map, user flows, and database schema. Read it before any structural change.

## Status

- Phase 2 complete (API exploration scripts + samples in tools/api_exploration/). Next: Phase 3 — Supabase schema + RLS.
